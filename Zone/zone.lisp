...
;;;
;;; This generic function is part of the geometry-change protocol.  It
;;; is called whenever the position or size of the zone is explicitly
;;; changed by a call to (SETF HPOS), (SETF VPOS), (SETF WIDTH), or
;;; (SETF HEIGHT).
